      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="home2-banner-content">
            ...
            <h1 className="animate-text" ref={animateTextContainerRef}>Let’s Explore The
               <span>World</span> 
              <span>Culture</span> 
              <span>Nature</span> 
              Together.</h1>
                    ...
                    <div className="row g-xl-4 gy-4">
                      <div className="col-xl-3 col-sm-6 d-flex justify-content-center divider">
                        <div className="single-search-box">
                          ...
                          <DestinationSearch destination="Destination" style="style-2"  />
                        </div>
                      </div>
                      <div className="col-xl-3 col-sm-6 d-flex justify-content-center divider">
                        <div className="single-search-box">
                          ...
                          <TourCategoryDropdown style="style-2" noScroll="two" labelType="Itinerary Type" data={['Family Tour','Honeymoon Tou','Group Tour','Adventure Tour','Solo Tour']} />
                        </div>
                      </div>
                      <div className="col-xl-3 col-sm-6 d-flex justify-content-center divider">
                        <div className="single-search-box">
